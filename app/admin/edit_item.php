						...
						<form method="POST" enctype="multipart/form-data">
							<div class="mb-3">
								...
								<input type="text" class="form-control" id="nombre" name="nombre" 
									   value="<?php echo htmlspecialchars($item['nombre'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" 
									   required>
							</div>
							...
							<div class="mb-3">
								...
								<input type="number" step="0.01" min="0.01" class="form-control" id="precio" name="precio" 
									   value="<?php echo htmlspecialchars($item['precio'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" 
									   required>
							</div>
							...
							<div class="mb-3">
								...
								<?php if ($item['imagen_url']): ?>
									<div class="mb-2">
										<img src="<?php echo htmlspecialchars($basePath, ENT_QUOTES, 'UTF-8'); ?><?php echo htmlspecialchars($item['imagen_url'], ENT_QUOTES, 'UTF-8'); ?>" 
											 alt="Imagen actual" 
										...
										<div class="col-md-4 mb-2">
											<div class="form-check">
												...
												<label class="form-check-label" for="alergeno_<?php echo $alergeno['id']; ?>">
													<?php echo htmlspecialchars($alergeno['nombre'], ENT_QUOTES, 'UTF-8'); ?>
												</label>
											</div>
										</div>
									<?php endforeach; ?>
