								...
								<table class="table table-striped table-hover">
									...
									<tbody>
										<?php foreach ($valoraciones as $valoracion): ?>
											<tr>
												<td><?php echo htmlspecialchars($valoracion['id'], ENT_QUOTES, 'UTF-8'); ?></td>
												<td><?php echo htmlspecialchars($valoracion['producto_nombre'], ENT_QUOTES, 'UTF-8'); ?></td>
												<td><?php echo htmlspecialchars($valoracion['cliente_nombre'], ENT_QUOTES, 'UTF-8'); ?></td>
												<td>
													<?php 
												...
												<td>
													<?php if (!empty($valoracion['comentario'])): ?>
														<?php echo nl2br(htmlspecialchars($valoracion['comentario'], ENT_QUOTES, 'UTF-8')); ?>
													<?php else: ?>
