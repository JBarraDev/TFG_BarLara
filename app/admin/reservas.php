										...
										<?php foreach ($reservas as $reserva): ?>
											<tr>
												<td>
													...
													echo htmlspecialchars($fechaObj->format('d/m/Y H:i'), ENT_QUOTES, 'UTF-8'); 
													?>
												</td>
												<td><?php echo htmlspecialchars($reserva['user'], ENT_QUOTES, 'UTF-8'); ?></td>
												<td><?php echo htmlspecialchars($reserva['email'], ENT_QUOTES, 'UTF-8'); ?></td>
												<td><?php echo htmlspecialchars($reserva['telefono'] ?? '-', ENT_QUOTES, 'UTF-8'); ?></td>
												<td><?php echo htmlspecialchars($reserva['num_personas'], ENT_QUOTES, 'UTF-8'); ?></td>
												<td>
													<span class="badge bg-info text-dark">
														<?php echo htmlspecialchars(ucfirst($reserva['zona']), ENT_QUOTES, 'UTF-8'); ?>
													</span>
												</td>
												<td>
													<div class="btn-group" role="group">
														<form method="POST" action="../process/process_reserva_admin.php" class="d-inline">
															<input type="hidden" name="reserva_id" value="<?php echo htmlspecialchars($reserva['id'], ENT_QUOTES, 'UTF-8'); ?>">
