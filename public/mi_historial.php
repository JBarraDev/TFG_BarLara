										...
										<div class="card shadow-sm">
											<div class="card-body">
												<div class="d-flex justify-content-between align-items-start mb-2">
													<h5 class="card-title mb-0">Reserva #<?php echo htmlspecialchars($reserva['id'], ENT_QUOTES, 'UTF-8'); ?></h5>
												...
												<p class="text-muted mb-1">
													<strong>Personas:</strong> <?php echo htmlspecialchars($reserva['num_personas'], ENT_QUOTES, 'UTF-8'); ?>
												</p>
