							...
							<div class="row g-4">
								...
								<div class="col-md-6">
									...
									<input type="date" 
										   ...
										   name="fecha" 
										   required 
										   min="<?php echo htmlspecialchars($fechaMinima, ENT_QUOTES, 'UTF-8'); ?>">
									<small class="text-muted">Fecha mínima: <?php echo htmlspecialchars($fechaMinimaFormato, ENT_QUOTES, 'UTF-8'); ?></small>
								</div>
									...
									<select class="form-select form-select-lg" id="hora" name="hora" required>
										...
										for ($h = 9; $h <= 23; $h++) {
											...
											foreach ($horas as $hora) {
												if ($hora !== null) {
													echo '<option value="' . htmlspecialchars($hora, ENT_QUOTES, 'UTF-8') . '">' . htmlspecialchars($hora, ENT_QUOTES, 'UTF-8') . '</option>';
												}
											}
										}
										?>
