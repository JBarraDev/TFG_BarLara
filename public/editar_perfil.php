							...
							<form method="POST" action="../app/process/process_editar_perfil.php">
								<div class="mb-3">
									...
									<input type="text" class="form-control" id="user" name="user" 
										   value="<?php echo htmlspecialchars($clienteData['user'], ENT_QUOTES, 'UTF-8'); ?>" 
										   required autofocus>
								</div>
								...
								<div class="mb-3">
									...
									<input type="email" class="form-control" id="email" name="email" 
										   value="<?php echo htmlspecialchars($clienteData['email'], ENT_QUOTES, 'UTF-8'); ?>" 
										   required>
								</div>
								...
								<div class="mb-3">
									...
									<input type="tel" class="form-control" id="telefono" name="telefono" 
										   value="<?php echo htmlspecialchars($clienteData['telefono'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" 
