										...
										<div class="card shadow-sm border-0 text-center p-4">
											<div class="card-body">
												<h5 class="card-title text-primary mb-3">
													<?php echo htmlspecialchars($valoracion['item_nombre'], ENT_QUOTES, 'UTF-8'); ?>
												</h5>
												...
												<blockquote class="blockquote mb-3">
													<p class="mb-0"><?php echo nl2br(htmlspecialchars($valoracion['comentario'], ENT_QUOTES, 'UTF-8')); ?></p>
												</blockquote>
												
												<!-- Usuario -->
												<footer class="blockquote-footer mt-3">
													<cite title="Usuario"><?php echo htmlspecialchars($valoracion['usuario'], ENT_QUOTES, 'UTF-8'); ?></cite>
												</footer>
											</div>
										</div>
									</div>
