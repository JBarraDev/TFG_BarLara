			...
			<div class="col-12 col-lg-8">
				...
				<?php if ($success): ?>
					<div class="alert alert-success alert-dismissible fade show" role="alert">
						<strong>¡Mensaje enviado!</strong> <?php echo htmlspecialchars($success, ENT_QUOTES, 'UTF-8'); ?>
								...
								<form method="POST" action="../app/process/process_contacto.php" id="formContacto">
									...
									<div class="mb-4">
										...
										<input type="text" 
											   ...
											   required
											   value="<?php echo htmlspecialchars($formData['asunto'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
									</div>
									...
									<div class="mb-4">
										...
										<textarea class="form-control form-control-lg" 
												  ...
												  required><?php echo htmlspecialchars($formData['mensaje'] ?? '', ENT_QUOTES, 'UTF-8'); ?></textarea>
									</div>
