							...
							<div class="card shadow-sm">
								<div class="card-body">
									...
									<?php foreach ($carrito as $item): ?>
										<div class="d-flex justify-content-between align-items-center mb-3 pb-3 border-bottom item-carrito" data-item-id="<?php echo htmlspecialchars($item['id_menu_item'], ENT_QUOTES, 'UTF-8'); ?>">
											<div class="flex-grow-1">
												<h5 class="mb-1"><?php echo htmlspecialchars($item['nombre'], ENT_QUOTES, 'UTF-8'); ?></h5>
												<p class="text-muted mb-0"><?php echo number_format($item['precio'], 2, ',', '.'); ?> € cada uno</p>
											</div>
											<div class="d-flex align-items-center gap-3">
												<div class="d-flex align-items-center gap-2">
													<button type="button" class="btn btn-sm btn-outline-secondary btn-quantity" data-action="decrease" data-item-id="<?php echo htmlspecialchars($item['id_menu_item'], ENT_QUOTES, 'UTF-8'); ?>">-</button>
													<span class="quantity-display fw-bold"><?php echo htmlspecialchars($item['cantidad'], ENT_QUOTES, 'UTF-8'); ?></span>
													<button type="button" class="btn btn-sm btn-outline-secondary btn-quantity" data-action="increase" data-item-id="<?php echo htmlspecialchars($item['id_menu_item'], ENT_QUOTES, 'UTF-8'); ?>">+</button>
												</div>
												<div class="text-end text-end-min-width">
													<strong class="text-primary"><?php echo number_format($item['precio'] * $item['cantidad'], 2, ',', '.'); ?> €</strong>
												</div>
												<button type="button" class="btn btn-sm btn-outline-danger btn-remove" data-item-id="<?php echo htmlspecialchars($item['id_menu_item'], ENT_QUOTES, 'UTF-8'); ?>">
													✕
												</button>
											</div>
										</div>
